            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link to="/books" className="text-sm font-medium text-slate-600 hover:text-primary transition-colors">
                            Read Books
                        </Link>
                        <Link to="/write" className="text-sm font-medium text-slate-600 hover:text-primary transition-colors">
                            Write a Book
                        </Link>
            ...
            {isMenuOpen && (
                <div className="md:hidden border-t border-slate-100 bg-white p-4 shadow-lg">
                    <nav className="flex flex-col gap-4">
                        ...
                        <Link to="/write" className="text-base font-medium text-slate-600">
                            Write a Book
                        </Link>
                        <Link to="/pricing" className="text-base font-medium text-slate-600">
                            Pricing
                        </Link>
